 ...
 * @author Titus Kruse
 */
@FacesComponent("de.tikron.faces.OutputDelimited")
public class OutputDelimited extends UIOutput {

	public static final String COMPONENT_TYPE = "de.tikron.faces.OutputDelimited";
	...
	public OutputDelimited() {
		setRendererType("de.tikron.faces.OutputDelimited");
	}
